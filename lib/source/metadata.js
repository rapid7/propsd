...
Source.Polling.extends(Metadata);
...
Metadata.prototype._fetch = function(callback) {
  var _this = this;
 ...
 *
 */
Metadata.Parser = function(options) {
  Parser.Properties.call(this);
  this.namespace = options.namespace;
};

Parser.Properties.extends(Metadata.Parser);

Metadata.Parser.prototype.update = function(data) {
  var _this = this;
  var properties = {};
