 ...
 * @extends Source
 */
var Polling = module.exports = function(parser, options, update) {
  Source.call(this, parser, options, update);
};

Source.extends(Polling);

Polling.override('configure', function(parent, params) {
 ...
 * @return {Void}
 */
Polling.prototype._fetch = function(callback) {
 ...
 */
Polling.override('initialize', function(parent, ready) {
 ...
 * @return {Polling} Receiver
 */
Polling.override('shutdown', function(parent) {
  parent();
...
/**
 * Theck the status of the polling interval loop
 *
 * @return {Boolean} True if the pooling loop is running
 */
Polling.prototype.running = function() {
 ...
 * @return {Object}
 */
Polling.override('status', function(parent) {
  var output = parent();
