...
Storage.initialize = function () {
  ...
  //   name: 'instance-tags',
  //   interval: Config.get('tags:interval'),
  //   resource: 'instance'
  // }, () => this.update());
  ...
  this.metadata.initialize(() => {
    // this.tags.id = this.metadata.properties.instance['instance-id'];
...
Storage.update = function () {
  ...
  this._update = setTimeout(function () {
    ...
    _this.sources.forEach(function (source) {
      Reflect.merge.deep(source.properties, properties);
    });
